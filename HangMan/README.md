...
### Features:  
  1.🎲 Random word selection from a predefined list  
   2. 🔤 Letter-by-letter guessing system  
   3.🧠 Full-word guessing option  
   4.  ❌ Tracks incorrect guesses and displays them  
   5.  🔁 Prevents duplicate guesses from consuming attempts  
   6.  ❤️ Limited number of attempts (10 guesses)  
### 🧠 What I Learned  
Through this project, I gained hands-on experience with:  
-  Applying basic principles from Clean Code book By Robert Cecil Martin
